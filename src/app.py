...
activities = {
    ...
    "Swimming Club": {
        "description": "Swim training sessions and water safety practice",
    ...
    "Art Club": {
        ...
        "max_participants": 18,
        "participants": ["lily@mergington.edu", "nate@mergington.edu"]
    },
    "Drama Club": {
        "description": "Rehearse plays and learn stage production techniques",
        "schedule": "Fridays, 3:30 PM - 5:30 PM",
        "max_participants": 16,
        "participants": ["ava@mergington.edu", "ethan@mergington.edu"]
    },
    "Debate Team": {
        "description": "Research current issues and compete in debate tournaments",
